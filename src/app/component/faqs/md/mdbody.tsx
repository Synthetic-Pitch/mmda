...
const MdFaqsbody = () => {
  ...
  return (
    <div className='pt-16 px-8'>
        <h1 className='font-justanother-hand text-8xl px-4'>FAQs</h1>
        <Card>
          <Accordion type='single' collapsible>
            <AccordionItem value='1'>
              
              <AccordionTrigger 
                className='px-3 font-mono font-bold'>What is the MMDA&apos;s No-Contact Apprehension Program (NCAP)?
              </AccordionTrigger>
              <AccordionContent 
                className="px-3 text-sm font-mono text-[#555555]">
