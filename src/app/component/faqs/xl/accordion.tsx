    ...
    <div className='overflow-x-hidden px-20'>
            ...
            <Accordion type="single" collapsible >
                ...
                <AccordionItem value="item-2" >
                    <AccordionTrigger>How can I pay fines for traffic violations issued by the MMDA?</AccordionTrigger>
                    <AccordionContent className="px-3 text-sm">
                ...
                <AccordionItem value="item-3" >
                    <AccordionTrigger>What should I do if I receive a notice of violation for a vehicle I no longer own?</AccordionTrigger>
                    <AccordionContent className="px-3 text-sm">
                ...
                <AccordionItem value="item-4" >
                    <AccordionTrigger>How can I contest a traffic violation issued by the MMDA?</AccordionTrigger>
                    <AccordionContent className="px-3 text-sm">
                        If you receive a notice of violation for a vehicle you no longer own, you should submit proof of sale or transfer to the MMDA along with a notarized affidavit to dispute the violation.
                    </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-5" >
                    <AccordionTrigger>What are the penalties for common traffic violations under the MMDA&apos;s Single Ticketing System?</AccordionTrigger>
                    <AccordionContent className="px-3 text-sm">
                        <p className="font-poppins text-[12px] font-bold">
